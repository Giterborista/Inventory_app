...
const steps: TutorialStep[] = [
  ...
  { title: "Project actions", body: "Download, open, report, and new-project commands are kept together in the left sidebar. Remember to select Download project frequently so you keep a portable backup; browser autosave remains only in this browser.", target: '[data-tutorial="sidebar-actions"]' },
